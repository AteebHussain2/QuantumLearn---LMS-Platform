...
const HeroSection = () => {
    return (
        <div className='relative h-[55vh] w-full'>
            <div className='absolute inset-0 z-[0] bg-gradient-to-b from-black/10 0 to-black/55 dark:from-white/15 dark:to-black/40' />
            <div className='absolute inset-0 z-[0] bg-gradient-to-t from-background via-background/80 to-background/20' />

            <div className="relative container m-auto px-4 h-full flex flex-col justify-center items-start">
